...
with tf.Session(config=config) as sess:
  ...
  saver.restore(sess, 'C:/TFLogs/tmp/finetune_alexnet/model_epoch566.ckpt')
  ...
  for epoch in range(num_epochs):
        ...
        print("{} Epoch number: {}".format(datetime.now(), epoch+567))
        ...
        checkpoint_name = os.path.join(checkpoint_path, 'model_epoch'+str(epoch+567)+'.ckpt')
